...
public class NewItensTest {
	...
	public void setBefore() {
		...
		this.itens.adicionaItemPorQtd("Agua Sanitaria ideal", "limpeza", 2, "l", "Supermercado EhNois", 2.0);
	...
	public void testToString() {
		assertEquals("1. Agua Sanitaria Drogon, limpeza, 1 l, Preco: <Supermercado Excepcional, R$ 2,19;>", this.itens.getItem(0).toString());
	}
